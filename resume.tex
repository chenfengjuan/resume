...
负责公司大数据方向产品的前端，直接参与开发Jarvis（PC和APP）、实时计算、即席查询等项目；
以及大数据方向产品前端（包含日志采集、元数据管理、ETL等项目）的需求评审、任务划分、排期、进度跟踪、跨团队沟通、项目的各环境部署和上线；
参与公司前端基础物料的开发与维护、稳定编写；带领应届生做项目。
\end{onehalfspacing}

\datedsubsection{\textbf{上海景栗科技有限公司}, 前端开发工程师}{2016.9-2018.3}
\begin{onehalfspacing}
负责BI大数据系统的前端开发和交互设计。了解大数据相关产品和团队一起完善BI项目为公司的各部门运营提供便捷的周报日报，统计分析工具。参与公司微信社群的运营的SASS系统部分模块的前端开发。
\end{onehalfspacing}
