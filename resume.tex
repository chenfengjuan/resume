...
Jarvis实现了从数据接入整合，到数据处理、分析、挖掘，再到多终端可视化，对数据进行全价值链管理的一站式数据管理和分析平台。
\begin{itemize}
  \item 基于D3、zrender、和vue实现的支持svg和canvas两种模式的图表库;
  \item 图表编辑模: 任意纬度的拖拽数据、排序、聚合、高级计算等分析功能，公式编辑计算字段、全局筛滤器、图内筛选器、图表配置等功能;
