...
\datedsubsection{\textbf{           人人车}, 中级前端开发工程师}{2018.4 - 至今}
...
\datedsubsection{\textbf{瓦力}}{前端, 2018.04-至今}
\begin{onehalfspacing}
\textit{Walle}是一个可自由配置项目，更人性化，高颜值，支持git、多用户、多语言、多项目、多环境同时部署的开源上线部署系统。\textit{Walle}让用户的代码发布终于可以不只能选择\textit{jenkins}。支持各种web代码发布，php、java、python、go等代码的发布、回滚可以通过web来一键完成。
\begin{itemize}
  \item 类gitlab的RESTful API，类gitlab的权限模型，将来打通gitlab，良心的惊喜;
  \item 空间管理。意味着有独立的空间资源：环境管理、用户组、项目、服务器等;
  \item websocket 实时展示部署中的 shell console;
  \item 完善的通知机制。邮件、钉钉;
\end{itemize}
\end{onehalfspacing}
