...
\datedsubsection{\textbf{华中科技大学}, 软件工程, 软件学院}{2011.09-2015.06}

\section{\faGraduationCap\  工作经历}
\datedsubsection{\textbf{           人人车}, 中级前端开发工程师}{2018.04 - 至今}
\datedsubsection{\textbf{上海景栗科技有限公司}, 前端开发工程师}{2016.09-2018.03}
\datedsubsection{\textbf{上海海隆软件有限公司}, 软件开发工程师}{2015.09-2016.09}

\section{\faUsers\ 开源项目}

\datedsubsection{\textbf{瓦力(\linkedin [官网]{http://walle-web.io})}}{前端, 2018.09-至今}
...
\datedsubsection{\textbf{Jarvis}}{人人车, 2018.04-至今}
\begin{onehalfspacing}
Jarvis实现了从\textbf{数据接入整合，到数据处理、分析、挖掘，再到多终端可视化}，对数据进行全价值链管理的一站式\textbf{数据管理和分析}平台。
\begin{itemize}
  \item 基于\textit{D3}、\textit{zrender}、和\textit{vue}实现的支持\textit{svg}和\textit{canvas}两种模式的图表库;
  \item 图表编辑: 任意纬度的拖拽数据、排序、聚合、高级计算等分析功能，公式编辑计算字段、全局筛滤器、图内筛选器、图表配置等功能;
...
\datedsubsection{\textbf{实时计算}}{人人车, 2018.08-至今}
\begin{onehalfspacing}
...
\datedsubsection{\textbf{即席查询}}{人人车, 2018.09-至今}
\begin{onehalfspacing}
...
\datedsubsection{\textbf{ETL}}{人人车, 2019.01-至今}
\begin{onehalfspacing}
...
\datedsubsection{\textbf{BI商务智能系统}}{上海景栗科技有限公司, 2017.04-2018.01}
\begin{onehalfspacing}
...
\datedsubsection{\textbf{SASS系统}}{上海景栗科技有限公司, 2016.10--2017.03}
\begin{onehalfspacing}
...
\datedsubsection{\textbf{软件开发工程师}}{上海海隆软件有限公司, 2015.09-2016.09}
\begin{onehalfspacing}
日本花旗银行系统的维护和更新
\begin{itemize}
